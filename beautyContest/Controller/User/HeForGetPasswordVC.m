...
- (IBAction)getCodeButtonClick:(UIButton *)sender
{
    ...
    NSString *requestUrl = [NSString stringWithFormat:@"%@/user/sendSmsforgetPassword.action",BASEURL];
...
- (IBAction)resetButtonClick:(UIButton *)sender
{
    ...
    NSDictionary * params  = @{@"forgetCode":Passwordcode};
    NSString *requestUrl = [NSString stringWithFormat:@"%@/user/ResetPasswordComparison.action",BASEURL];
...
- (IBAction)commitButtonClick:(id)sender
{
    ...
    NSString *requestUrl = [NSString stringWithFormat:@"%@/user/ResetPasswordUpdate.action",BASEURL];
