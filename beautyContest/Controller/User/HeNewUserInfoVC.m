...
@interface HeNewUserInfoVC ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation HeNewUserInfoVC
...
- (void)initView
{
    ...
    CGFloat buttonY = 30;
    CGFloat buttonX = 20;
    UIButton *backButton = [[UIButton alloc] initWithFrame:CGRectMake(buttonX, buttonY, buttonW, buttonH)];
    [backButton setBackgroundImage:[UIImage imageNamed:@"navigationBar_back_icon"] forState:UIControlStateNormal];
