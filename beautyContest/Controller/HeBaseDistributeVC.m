...
- (void)initView
{
    ...
    headerBGView.backgroundColor = APPDEFAULTTABLEBACKGROUNDCOLOR;
    ...
    distributeTF.layer.borderColor = [[UIColor blackColor] CGColor];
    ...
    [addPictureButton setBackgroundImage:[UIImage imageNamed:@"distribute_addImageIcon_normal.png"] forState:UIControlStateNormal];
    [addPictureButton setBackgroundImage:[UIImage imageNamed:@"distribute_addImageIcon_hightlighted.png"] forState:UIControlStateHighlighted];
    ...
    subdisview.backgroundColor = APPDEFAULTTABLEBACKGROUNDCOLOR;
    ...
    [distributeImageBG setBackgroundColor:APPDEFAULTTABLEBACKGROUNDCOLOR];
