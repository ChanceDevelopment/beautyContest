...
//shareSDK的key
#define SHARESDKKEY @"17ade611106a8"
#define SHARESDKAPPSECRET @"b68bf49fa1205fad5933e11ec94fc270"
...
#define EMPTYSTRING @"     : "
//默认橙色的RGB
#define APPDEFAULTORANGE ([UIColor colorWithRed:0.0 / 255.0 green:167.0 / 255.0 blue:199.0 / 255.0 alpha:1.0])
//默认标题颜色
